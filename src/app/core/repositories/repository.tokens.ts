...
// Groups Tokens
export const GROUPS_REPOSITORY_TOKEN = new InjectionToken<IBaseRepository<any>>('IGroupsRepository');

// People Tokens
export const PEOPLE_REPOSITORY_TOKEN = new InjectionToken<IBaseRepository<any>>('IPeopleRepository');
